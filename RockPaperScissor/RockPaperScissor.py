...
user_label = Label(root, image=scissor_img, bg="#ffffff")
comp_label = Label(root, image=scissor_img_comp, bg="#ffffff")
comp_label.grid(row=1, column=1, padx=20, pady=20)
user_label.grid(row=1, column=3, padx=20, pady=20)

playerScore = Label(root, text=user_score, font=("Arial", 40, "bold"), bg="#ffffff", fg="black")
computerScore = Label(root, text=computer_score, font=("Arial", 40, "bold"), bg="#ffffff", fg="black")
computerScore.grid(row=1, column=2)
playerScore.grid(row=1, column=4)

user_indicator = Label(root, font=("Arial", 20, "bold"), text=": USER :", bg="#ffffff", fg="black")
comp_indicator = Label(root, font=("Arial", 20, "bold"), text=": COMPUTER :", bg="#ffffff", fg="black")
user_indicator.grid(row=0, column=4, padx=20)
comp_indicator.grid(row=0, column=2, padx=20)

msg = Label(root, font=("Arial", 20, "bold"), bg="#ffffff", fg="Black")
msg.grid(row=3, column=2, columnspan=2, pady=20)

round_label = Label(root, font=("Arial", 16, "bold"), text="Rounds Played: 0", bg="#ffffff", fg="black")
